...
export const getGetRetroFundingRoundBallotsResponseRound5BallotMock = (
  ...
  ...{
    address: faker.helpers.arrayElement([faker.word.sample(), undefined]),
    catgory_allocation: faker.helpers.arrayElement([
      Array.from(
        { length: faker.number.int({ min: 1, max: 10 }) },
        (_, i) => i + 1
      ).map(() => ({
    ...
    voting_step: faker.helpers.arrayElement([
      faker.number.int({ min: undefined, max: undefined }),
      undefined,
    ]),
  },
  ...
  ballots: faker.helpers.arrayElement([
    Array.from(
      ...
      faker.helpers.arrayElement([
        ...
        { ...getGetRetroFundingRoundBallotsResponseRound5BallotMock() },
      ])
    ),
    undefined,
  ]),
...
export const getSubmitRetroFundingBallotResponseRound4BallotMock = (
  overrideResponse: Partial<Round4Ballot> = {}
): Round4Ballot => ({
  ...{
    address: faker.helpers.arrayElement([faker.word.sample(), undefined]),
...
export const getSubmitRetroFundingBallotResponseRound5BallotMock = (
  overrideResponse: Partial<Round5Ballot> = {}
): Round5Ballot => ({
  ...{
    address: faker.helpers.arrayElement([faker.word.sample(), undefined]),
...
export const getSubmitRetroFundingBallotResponseMock =
  (): SubmitRetroFundingBallot200 =>
    faker.helpers.arrayElement([
      { ...getSubmitRetroFundingBallotResponseRound4BallotMock() },
      { ...getSubmitRetroFundingBallotResponseRound5BallotMock() },
    ]);
...
export const getUpdateRetroFundingRoundProjectByIdMockHandler = (
  overrideResponse?:
    | Round5Ballot
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0]
