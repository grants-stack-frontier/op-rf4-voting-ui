	...
	return useQueryStates(
		{
			...
			order: parseAsStringEnum<OrderBy>(Object.values(OrderBy)).withDefault(OrderBy.name),
			sort: parseAsStringEnum<SortOrder>(Object.values(SortOrder)).withDefault(SortOrder.asc),
		},
		{ history: 'replace' }
	);
}
