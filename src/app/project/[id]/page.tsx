...
export default function ProjectDetailsPage({ params }: { params: { id: string } }) {
	...
	const { isUnlocked, setIsUnlocked, handleScoreSelect, isLoading: isProjectScoringLoading, isSaving } = useProjectScoring(
	...
	const { isConflictOfInterestDialogOpen, setIsConflictOfInterestDialogOpen, handleConflictOfInterestConfirm } = useConflictOfInterest(handleScore);
	...
	const isLoading = useMemo(() =>
		isProjectsLoading || isProjectLoading || !currentProject || isProjectScoringLoading,
		[isProjectsLoading, isProjectLoading, currentProject, isProjectScoringLoading]
	);
