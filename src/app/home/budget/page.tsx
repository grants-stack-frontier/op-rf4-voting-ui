								...
								<div className="flex items-center gap-4 py-4" key={category.id}>
									...
									<div className="flex-1">
										<Button variant="link" asChild>
											<Link href={`/home/category/${category.id}`} className="flex items-center gap-2">
									...
									<div className="flex flex-col items-center">
										<div className="flex rounded-lg bg-transparent border w-1/2">
											<Button size="icon" type="button" variant="ghost" className="w-20 outline-none hover:bg-transparent">
												<Minus className="h-4 w-4" />
											</Button>
											<Input type="text" className="border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-center" value="33%" />
											<Button size="icon" type="button" variant="ghost" className="w-20 outline-none hover:bg-transparent">
